<template>
  <div class="listing-card card">
    <div class="listing-image">
      ...
      <div v-if="searchFilters.status === ''" class="status-badge" :class="statusClass">
        {{ statusText }}
      </div>
    </div>
    <div class="listing-content">
      ...
      <div class="listing-meta">
        <p v-if="searchFilters.city === ''" class="listing-address">📍 {{ userAddress }}</p>
        <div v-if="searchFilters.categoryId === ''" class="category-tag" :style="{ borderColor: categoryColor, color: categoryColor }">
          {{ categoryName }}
        </div>
      </div>
...
const searchFilters = computed(() => {
  console.log('ListingCard-searchFilters')
  return listingsStore.searchOptions.searchFilters
})
